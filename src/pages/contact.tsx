            ...
            <motion.div variants={routeAnimation} initial="initial" animate="animate" exit="exit" >
                ...
                <div className="relative max-w-7xl container mx-auto flex flex-col lg:flex-row  overflow-hidden px-6 ">
                    ...
                    <div className='flex flex-col space-y-8 '>
                        ...
                        {/* <motion.h1 variants={fadeInUp} className='text-xl md:text-1xl  lg:text-3xl text-let tracking-widest max-w-2xl ' >My red social</motion.h1>
                        <motion.div variants={fadeInUp} className='flex flex-col space-y-5 mt-4'>
                            <h3 className='font-medium text-dev text-lg md:text-2xl tracking-widest' >➤  linkedin</h3>

                            <h3 className='font-medium text-dev text-lg md:text-2xl tracking-widest' >➤ instagram</h3>
